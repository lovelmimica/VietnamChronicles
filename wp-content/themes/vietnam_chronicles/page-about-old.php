  ...
  <div class="container-main main-section">
    <div class="w-container">
      <h1 class="heading-68 page_title">Welcome to Vietnam Chronicles!</h1>
      <div class="part-container">
        <div class="no-mp align-vertical-centre w-row">
          <div class="pl-10 pl-10 pr-10 w-col w-col-3"><img src="<?php echo get_site_url() ?>/wp-content/uploads/2020/09/front_page.Antonio.jpeg" alt="Antonio">
            <span class='user-card__sm-icons'>
              <a href='<?php echo get_the_author_meta( 'facebook', 3 ) ?>'> <i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a>
              <a href='<?php echo get_the_author_meta( 'instagram', 3 ) ?>'><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a>
              <a href='<?php echo get_the_author_meta( 'linkedin', 3 ) ?>'><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
            </span> 
          </div>
          <div class="pl-10 pr-10 w-col w-col-9">
          
          <h3 class="align-left about-us__user-title">
          <a class='team_member-link' href='<?php echo get_site_url() ?>/author/antonio/'>
              Antonio Gabrić
              </a>
            </h3>
      ...
      <div class="part-container">
        <div class="no-mp align-vertical-centre row-odd w-row">
          <div class="pl-10 pr-10 w-col w-col-3"><img src="<?php echo get_site_url() ?>/wp-content/uploads/2020/04/front_page.david_.jpeg" alt="David">
            <span class='user-card__sm-icons user-card__sm-icons_reverese'>
              <a href='<?php echo get_the_author_meta( 'facebook', 2 ) ?>'> <i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a>
              <a href='<?php echo get_the_author_meta( 'instagram', 2 ) ?>'><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a>
              <a href='<?php echo get_the_author_meta( 'linkedin', 2 ) ?>'><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
             </span>
          </div>
          <div class="pl-10 pr-10 w-col w-col-9">
          <h3 class="align-right about-us__user-title"><a class='team_member-link' href='<?php echo get_site_url() ?>/author/david/'>David Gabrić</a>
          </h3>
      ...
      <div class="part-container">
        <div class="no-mp align-vertical-centre w-row">
          <div class="pl-10 pr-10 w-col w-col-3"><img src="<?php echo get_site_url() ?>/wp-content/uploads/2020/04/front_page.lovel_.jpeg" alt="Lovel">
                <span class='user-card__sm-icons'>
                  <a href='<?php echo get_the_author_meta( 'facebook', 1 ) ?>'> <i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a>
                  <a href='<?php echo get_the_author_meta( 'linkedin', 1 ) ?>'><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
                </span>  
          </div>
      ...
      <div class='contact-us-button-wrapper'><a href="<?php echo get_site_url() ?>/contact/" class="link-btn w-inline-block contact-us-button-wrapper">
        <span class="text-button contact-us-button">CONTACT US</span>
      </a></div>
    </div>
  </div>
  <?php get_footer() ?>